...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.server.FileDownloader","com.vaadin.ui.Label","com.vaadin.ui.Video","com.vaadin.ui.FormLayout","com.vaadin.ui.TwinColSelect","com.vaadin.ui.BrowserFrame","com.vaadin.ui.TextArea","com.vaadin.ui.Audio","com.vaadin.ui.JavaScript","com.vaadin.ui.TextField","com.vaadin.ui.Embedded","com.vaadin.ui.CustomComponent","com.vaadin.ui.ComboBox","com.vaadin.ui.Flash","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Tree","com.vaadin.ui.Accordion","com.vaadin.ui.Slider","com.vaadin.ui.PasswordField","com.vaadin.ui.CustomLayout","com.vaadin.ui.TabSheet","com.vaadin.ui.AbstractJavaScriptComponent","com.vaadin.ui.OptionGroup","com.vaadin.ui.DateField","com.vaadin.ui.PopupView","com.vaadin.ui.UI","com.vaadin.ui.TreeTable","com.vaadin.ui.Image","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.CustomField","com.vaadin.ui.VerticalLayout","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.NativeButton","com.vaadin.ui.GridLayout","com.vaadin.ui.NativeSelect","com.vaadin.ui.InlineDateField","com.vaadin.ui.Window","com.vaadin.ui.Upload","com.vaadin.ui.Form","com.vaadin.ui.CheckBox","com.vaadin.ui.Link","com.vaadin.ui.Panel","com.vaadin.ui.MenuBar","com.vaadin.ui.Table","com.vaadin.ui.Button","com.vaadin.ui.ProgressIndicator","com.vaadin.ui.CssLayout","com.vaadin.ui.ListSelect","com.vaadin.server.BrowserWindowOpener","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.VerticalSplitPanel",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"readOnly", "description", "errorMessage", "width", "immediate", "primaryStyleName", "inputPrompt", "resources", "id", "propertyReadOnly", "height", "required", "caption", "text", "modified", "styles", "enabled", "registeredEventListeners", "columns", "hideErrors", "maxLength", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"resources", "readOnly", "id", "altText", "htmlContentAllowed", "sourceTypes", "immediate", "caption", "showControls", "primaryStyleName", "errorMessage", "muted", "autoplay", "enabled", "registeredEventListeners", "width", "styles", "height", "description", "sources", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"maxPosition", "locked", "minPositionUnit", "maxPositionUnit", "minPosition", "positionUnit", "position", "positionReversed", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"registeredEventListeners", "styles", "enabled", "errorMessage", "readOnly", "height", "description", "immediate", "id", "width", "primaryStyleName", "resources", "caption", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"hideErrors", "id", "caption", "errorMessage", "required", "resolution", "readOnly", "description", "maxValue", "orientation", "modified", "height", "resources", "width", "immediate", "tabIndex", "primaryStyleName", "minValue", "registeredEventListeners", "propertyReadOnly", "styles", "value", "enabled", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"secondChild", "readOnly", "description", "firstChild", "immediate", "enabled", "primaryStyleName", "splitterState", "width", "id", "resources", "height", "caption", "errorMessage", "styles", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"styles", "description", "errorMessage", "enabled", "primaryStyleName", "clickShortcutKeyCode", "id", "resources", "tabIndex", "height", "immediate", "registeredEventListeners", "width", "readOnly", "caption", "disableOnClick", "htmlContentAllowed", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"primaryStyleName", "immediate", "enabled", "errorMessage", "registeredEventListeners", "id", "height", "resources", "readOnly", "description", "alternateText", "caption", "styles", "width", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"immediate", "propertyReadOnly", "caption", "id", "readOnly", "hideErrors", "modified", "errorMessage", "styles", "registeredEventListeners", "required", "primaryStyleName", "enabled", "width", "height", "description", "resources", "tabIndex", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"type", "button", "relativeX", "relativeY", "shiftKey", "ctrlKey", "metaKey", "clientX", "clientY", "altKey", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"width", "description", "tabIndex", "primaryStyleName", "errorMessage", "enabled", "required", "caption", "id", "modified", "immediate", "propertyReadOnly", "height", "registeredEventListeners", "resources", "readOnly", "styles", "hideErrors", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"registeredEventListeners", "primaryStyleName", "immediate", "errorMessage", "height", "description", "readOnly", "id", "width", "resources", "enabled", "caption", "styles", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"enabled", "callbackNames", "registeredEventListeners", "resources", "rpcInterfaces", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"resources", "description", "primaryStyleName", "height", "id", "immediate", "errorMessage", "spacing", "width", "caption", "marginsBitmask", "readOnly", "registeredEventListeners", "enabled", "styles", "childData", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"immediate", "styles", "id", "width", "alternateText", "resources", "enabled", "readOnly", "caption", "errorMessage", "height", "primaryStyleName", "description", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"registeredEventListeners", "height", "description", "propertyReadOnly", "caption", "immediate", "errorMessage", "primaryStyleName", "width", "readOnly", "enabled", "styles", "resources", "required", "hideErrors", "modified", "id", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"caption", "styles", "resources", "readOnly", "htmlContentAllowed", "description", "immediate", "disableOnClick", "clickShortcutKeyCode", "width", "errorMessage", "id", "enabled", "primaryStyleName", "tabIndex", "height", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"enabled", "primaryStyleName", "readOnly", "styles", "id", "immediate", "resources", "registeredEventListeners", "height", "errorMessage", "childCss", "description", "caption", "width", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"styles", "height", "immediate", "primaryStyleName", "resources", "registeredEventListeners", "readOnly", "features", "caption", "uriFragment", "description", "id", "width", "target", "enabled", "parameters", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"registeredEventListeners", "tabIndex", "width", "primaryStyleName", "resources", "height", "id", "enabled", "description", "immediate", "errorMessage", "styles", "readOnly", "caption", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"id", "resources", "html", "height", "errorMessage", "immediate", "enabled", "hideOnMouseOut", "width", "description", "registeredEventListeners", "readOnly", "primaryStyleName", "caption", "styles", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"height", "tabIndex", "registeredEventListeners", "enabled", "resources", "errorMessage", "scrollLeft", "readOnly", "description", "styles", "scrollTop", "width", "id", "caption", "immediate", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"width", "rows", "childData", "resources", "immediate", "enabled", "columns", "description", "caption", "readOnly", "registeredEventListeners", "spacing", "primaryStyleName", "id", "marginsBitmask", "height", "errorMessage", "styles", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"primaryStyleName", "readOnly", "id", "description", "rpcInterfaces", "height", "width", "caption", "errorMessage", "styles", "resources", "callbackNames", "immediate", "registeredEventListeners", "enabled", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"caption", "width", "hideErrors", "enabled", "id", "required", "errorMessage", "readOnly", "modified", "resources", "height", "tabIndex", "immediate", "description", "styles", "registeredEventListeners", "primaryStyleName", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"registeredEventListeners", "id", "errorMessage", "styles", "height", "description", "modified", "primaryStyleName", "required", "tabIndex", "width", "readOnly", "immediate", "enabled", "caption", "resources", "hideErrors", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"height", "errorMessage", "id", "styles", "readOnly", "enabled", "description", "resources", "primaryStyleName", "caption", "registeredEventListeners", "width", "immediate", });
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"caption", "modal", "draggable", "immediate", "height", "enabled", "resizeLazy", "centered", "positionY", "errorMessage", "styles", "resizable", "positionX", "readOnly", "tabIndex", "registeredEventListeners", "scrollTop", "width", "description", "scrollLeft", "primaryStyleName", "resources", "id", });
            ...
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"readOnly", "primaryStyleName", "errorMessage", "id", "description", "immediate", "width", "height", "alternateText", "enabled", "styles", "resources", "registeredEventListeners", "caption", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"id", "registeredEventListeners", "enabled", "immediate", "description", "childData", "errorMessage", "styles", "marginsBitmask", "spacing", "height", "width", "primaryStyleName", "caption", "readOnly", "resources", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"height", "id", "required", "modified", "enabled", "propertyReadOnly", "hideErrors", "readOnly", "immediate", "caption", "registeredEventListeners", "primaryStyleName", "styles", "tabIndex", "description", "width", "resources", "errorMessage", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"tabIndex", "resources", "width", "enabled", "registeredEventListeners", "required", "primaryStyleName", "modified", "description", "height", "caption", "id", "styles", "propertyReadOnly", "hideErrors", "errorMessage", "readOnly", "immediate", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"classId", "caption", "archive", "registeredEventListeners", "resources", "errorMessage", "alternateText", "primaryStyleName", "readOnly", "styles", "codebase", "height", "width", "immediate", "id", "enabled", "standby", "codetype", "embedParams", "description", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"state", "registeredEventListeners", "pollingInterval", "height", "modified", "styles", "hideErrors", "immediate", "required", "id", "readOnly", "resources", "width", "primaryStyleName", "caption", "tabIndex", "propertyReadOnly", "description", "errorMessage", "indeterminate", "enabled", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"required", "description", "id", "modified", "readOnly", "propertyReadOnly", "registeredEventListeners", "enabled", "errorMessage", "hideErrors", "checked", "tabIndex", "height", "immediate", "resources", "caption", "styles", "primaryStyleName", "width", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"required", "tabIndex", "wordwrap", "maxLength", "enabled", "styles", "immediate", "width", "readOnly", "resources", "errorMessage", "columns", "id", "inputPrompt", "text", "primaryStyleName", "caption", "description", "registeredEventListeners", "propertyReadOnly", "hideErrors", "rows", "modified", "height", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"alignment", "column1", "column2", "row2", "row1", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"immediate", "registeredEventListeners", "firstChild", "resources", "errorMessage", "width", "secondChild", "description", "primaryStyleName", "styles", "enabled", "splitterState", "readOnly", "id", "caption", "height", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"sources", "muted", "styles", "htmlContentAllowed", "height", "primaryStyleName", "caption", "altText", "description", "readOnly", "resources", "showControls", "autoplay", "sourceTypes", "errorMessage", "width", "id", "enabled", "registeredEventListeners", "immediate", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"primaryStyleName", "immediate", "description", "readOnly", "caption", "id", "styles", "enabled", "registeredEventListeners", "height", "width", "errorMessage", "resources", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"height", "primaryStyleName", "caption", "styles", "registeredEventListeners", "immediate", "templateContents", "resources", "errorMessage", "childLocations", "templateName", "readOnly", "description", "enabled", "width", "id", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"resources", "marginsBitmask", "description", "styles", "childData", "spacing", "height", "readOnly", "registeredEventListeners", "id", "immediate", "enabled", "errorMessage", "width", "caption", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"height", "layout", "modified", "immediate", "required", "tabIndex", "footer", "description", "primaryStyleName", "readOnly", "enabled", "registeredEventListeners", "resources", "styles", "caption", "propertyReadOnly", "width", "hideErrors", "errorMessage", "id", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"styles", "width", "resources", "text", "errorMessage", "enabled", "height", "immediate", "registeredEventListeners", "readOnly", "id", "contentMode", "caption", "description", "primaryStyleName", });
            ...
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"registeredEventListeners", "resources", "textFieldEnabled", "hideErrors", "errorMessage", "id", "propertyReadOnly", "width", "description", "caption", "styles", "required", "primaryStyleName", "tabIndex", "enabled", "modified", "immediate", "height", "readOnly", });
            store.setProperties(com.vaadin.shared.extension.javascriptmanager.JavaScriptManagerState.class, new String[] {"enabled", "registeredEventListeners", "resources", "names", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"immediate", "id", "propertyReadOnly", "styles", "width", "resources", "readOnly", "height", "caption", "modified", "errorMessage", "registeredEventListeners", "hideErrors", "description", "tabIndex", "primaryStyleName", "enabled", "required", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"width", "styles", "height", "registeredEventListeners", "description", "errorMessage", "readOnly", "immediate", "resources", "connectorToCssPosition", "id", "primaryStyleName", "enabled", "caption", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"errorMessage", "id", "enabled", "registeredEventListeners", "styles", "immediate", "primaryStyleName", "height", "cursorX", "width", "cursorY", "bgColor", "readOnly", "description", "caption", "resources", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"color", "id", "styles", "width", "caption", "popupVisible", "height", "registeredEventListeners", "enabled", "showDefaultCaption", "immediate", "description", "resources", "errorMessage", "htmlContentAllowed", "primaryStyleName", "readOnly", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"styles", "columnCount", "resources", "changedColor", "description", "immediate", "primaryStyleName", "readOnly", "errorMessage", "id", "enabled", "caption", "changedX", "changedY", "registeredEventListeners", "height", "rowCount", "width", });
